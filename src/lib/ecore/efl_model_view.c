...
struct _Efl_Model_View_Data
{
   ...
   Eina_Hash *binded; // Stringhash of Efl_Model_View_Bind
                                   ...
                                   Eina_Iterator *binded)
{
   ...
   EINA_ITERATOR_FOREACH(binded, source)
     {
                              ...
                              const char *source, const char *destination)
{
   ...
   bind = eina_hash_find(pd->binded, src);
   if (!bind)
     {
        ...
        eina_hash_direct_add(pd->binded, bind->source, bind);
     }
                                ...
                                const char *source, const char *destination)
{
   ...
   if (!bind->destinations)
     eina_hash_del(pd->binded, dst, bind);
...
_efl_model_view_efl_object_constructor(Eo *obj, Efl_Model_View_Data *pd)
{
   ...
   pd->binded = eina_hash_stringshared_new(_bind_free);
