...
static Eina_Error
_efl_ui_win_part_file_load(Eo *obj, Efl_Ui_Win_Data *sd, const char *part)
{
   const char *file, *key;
...
static const char *
_efl_ui_win_part_file_get(const Eo *obj, Efl_Ui_Win_Data *sd, const char *part EINA_UNUSED)
{
   sd->legacy.forbidden = EINA_TRUE;
...
static const char *
_efl_ui_win_part_file_key_get(const Eo *obj, Efl_Ui_Win_Data *sd, const char *part EINA_UNUSED)
{
   sd->legacy.forbidden = EINA_TRUE;
   return efl_file_key_get(obj);
/* NOTE; if more than one part is ever supported here then this section is needed */
#if 0
...
_efl_ui_win_part_efl_file_file_get(const Eo *obj, void *_pd EINA_UNUSED)
{
   Elm_Part_Data *pd = efl_data_scope_get(obj, EFL_UI_WIDGET_PART_CLASS);
   Efl_Ui_Win_Data *sd = efl_data_scope_get(pd->obj, MY_CLASS);
   return _efl_ui_win_part_file_get(pd->obj, sd, pd->part);
}
...
_efl_ui_win_part_efl_file_key_get(const Eo *obj, void *_pd EINA_UNUSED)
{
   Elm_Part_Data *pd = efl_data_scope_get(obj, EFL_UI_WIDGET_PART_CLASS);
   Efl_Ui_Win_Data *sd = efl_data_scope_get(pd->obj, MY_CLASS);
   return _efl_ui_win_part_file_key_get(pd->obj, sd, pd->part);
}
...
_efl_ui_win_part_efl_file_load(Eo *obj, void *_pd EINA_UNUSED)
{
   Elm_Part_Data *pd = efl_data_scope_get(obj, EFL_UI_WIDGET_PART_CLASS);
   Efl_Ui_Win_Data *sd = efl_data_scope_get(pd->obj, MY_CLASS);
   return _efl_ui_win_part_file_load(pd->obj, sd, pd->part);
}
