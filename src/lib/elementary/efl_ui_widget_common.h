 ...
 *
 * @return A iterator that contains subelement widgets and canvas objects of the root widget.
 */
 ...
 * @param obj The widget which is the root of the subtree.
 *
 * @return A iterator that contains subelement widgets of the root widget.
 */
 ...
 *
 * @return A iterator that contains all parents of the object.
 */
