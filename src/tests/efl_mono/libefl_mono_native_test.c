...
void _dummy_test_object_setter_only_set(Eo *obj, Dummy_Test_Object_Data *pd, int value)
{
    pd->setter_only = value;
}

int _dummy_test_object_get_setter_only(Eo *obj, Dummy_Test_Object_Data *pd)
{
    return pd->setter_only;
}

void _dummy_test_object_dummy_test_iface_iface_prop_set(Eo *obj, Dummy_Test_Object_Data *pd, int value)
{
    pd->iface_prop = value;
}

int _dummy_test_object_dummy_test_iface_iface_prop_get(const Eo *obj, Dummy_Test_Object_Data *pd)
{
